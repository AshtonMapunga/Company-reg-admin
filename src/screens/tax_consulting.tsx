  ...
  if (loading) {
    return (
      <Box sx={{ 
        ...
        <Typography variant="h6">Loading tax consultancies...</Typography>
      </Box>
    );
  }
    ...
    <Box sx={{ 
      ...
      <Box sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary">
          View and manage all your tax consultancy applications
        </Typography>
      </Box>
      ...
      <Box sx={{ mb: 3 }}>
        <Typography variant="body2" color="text.secondary">
          Showing {filteredTaxConsultancies.length} of {taxConsultancies.length} tax consultancy applications
        </Typography>
      </Box>
        ...
        {filteredTaxConsultancies.length === 0 ? (
          ...
          >
            <Typography variant="h6" color="text.secondary">
              No tax consultancy applications found matching your filters.
            </Typography>
          </Paper>
        ) : (
          <Grid container spacing={3}>
      ...
      <Dialog open={deleteDialogOpen} onClose={() => setDeleteDialogOpen(false)}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to delete the tax consultancy application for {selectedTaxConsultancy?.companyName}?
          </Typography>
        </DialogContent>
        <DialogActions>
